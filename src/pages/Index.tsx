...
// Define local interface matching VapiButtonState from the utility
...
const Index = () => {
  ...
  //   const handleStateChange = (state: VapiButtonState) => {
  ...
  //   buttonManagerRef.current.onStateChange(handleStateChange);
  ...
  //     resetVideoLoadingState();
  //   };
  // }, [toast, startListening, stopListening]);
  ...
  return (
    <div className="min-h-screen overflow-hidden">
      ...
      <main>
        <CTA />
        {/* <button onClick={handleVapiClick}>Start Call</button> */}
        <Benefits />
        <SocialProof />
        <StepGuide />
        <FAQ />
