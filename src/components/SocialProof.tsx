    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10 opacity-0 animate-fade-up">
          <span className="bg-whatsapp/10 text-whatsapp px-4 py-1 rounded-full text-sm font-medium mb-4 inline-block">
            Success Stories
          </span>
        ...
        <div className="mt-16 max-w-3xl mx-auto text-center opacity-0 animate-fade-up delay-300">
          <div className="relative">
            ...
            <p className="relative text-xl text-gray-600 italic">
              "Our sales doubled after using WhatsApp Business. Customers love the instant chat & easy payments!"
            </p>
        ...
        <div className="mt-12 text-center mb-6">
          <a href="#" className="btn-whatsapp inline-flex items-center gap-2 bg-whatsapp text-white px-6 py-3 rounded-full font-medium hover:bg-whatsapp/90 transition-colors shadow-md">
